...
$sqlnota="select * from nota,alumno where nota.ASIG_ID = $asignatura AND  nota.SEME_ID = $semestre AND nota.ALUM_AÑOCURSADO = $cursado AND nota.JORN_ID = $jornada AND alumno.ALUM_RUT = nota.ALUM_RUT";
...
$sql2= "update nota set NOTA_PROMEDIO='$nota[$i]' where nota.ASIG_ID = $asig AND  nota.SEME_ID = $semes AND nota.ALUM_AÑOCURSADO = $cursado AND nota.JORN_ID = $jornada";
