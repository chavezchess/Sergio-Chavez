...
<table align="center">
<tr>
<td class="USUARIO">NOMBRE SEMESTRE </td>
<td>
<select name="cmbSemestre" id="cmbSemestre">
          <?php
...
$nombresemestre=$_POST['cmbSemestre'];

$sql="select * from semestre where SEME_ID like '%".$nombresemestre."%'";
...
<table width="310" border="1">
  <tr>
    <td width="69" class="USUARIO" align="center">ID</td>
    <td width="198" class="USUARIO" align="center">NOMBRE</td>
  </tr>
...
{
		echo "<tr>";
		echo "<td>".$reg["SEME_ID"]."</td>";
		echo "<td>".$reg["SEME_NOMBRE"]."</td>";
			echo "</tr>";
...
<p>
<p><a href="Filtrosseme.php" class="cerrar">VOLVER ATRAS</a> <p><a href="menu.php" class="cerrar">MENU PRINCIPAL</a>
</body>
</html>
